...
GRANULARITY=300
BATCHSIZE=30
EXPERIMENT_ID="estimated_train_extra_labels"
...
predict() {
    ...
    --start_index $1 \
    --end_index $2 \
    --cityscapes_img_zip data/cityscapes_train_extra_imgs.0.zip \
    --cityscapes_label_zip data/cityscapes_train_extra_labels.0.zip \
    --gpu 0 &
}
