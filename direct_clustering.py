...
def estimate_road_mask(imgs, img_fns, labels, label_fns, model, args):
    ...
    for img_fn, label_fn, clustering_result, road_mask in zip(img_fns, label_fns, clustering_results, road_masks):
        # Load image
        ...
        result_info = save_info(img_fn, label_fn, road_mask, clustering_result, label, elapsed_times, st_all)
